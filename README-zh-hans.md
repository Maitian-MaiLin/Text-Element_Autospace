...
| 源代码 | 实际渲染 | 测试描述 |
| ------ | ------ | -------- |
| `文本[图标]文本` `文本 [图标] 文本` | `文本[_图标_]文本` | 正常插入spacer并移除前后空格
| `文本，[图标]文本。` | `文本。[图标_]文本。` | 不在特殊标点符号前后插入spacer
| `——&nbsp;[图标]文本` | `——&nbsp;[图标_]文本` | 不在特殊标点符号前后插入spacer
| `[图标] 文本 • [图标] 文本` | `[图标_]文本 • [图标_]文本` | 不移除' • '等且不插入spacer
| `（文本）• [图标] 文本` | `（文本）• [图标_]文本` | 不移除'）• '等且不插入spacer
